...
export default class TurnosReservasServicio {
    ...
    crear = async (turnoReserva) => {
        ...
        // cambie la formula porque estaba mal segun dijo en clase
    ...
    // nueva funcionalidad permitir a al medico dejar observaciones
    //pero primero debe saber si el paciente fue atendido o no
